          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
            ...
            <div className="lg:w-1/2 text-center lg:text-left animate-fade-in-up z-20">
              ...
              <p className="text-lg sm:text-xl text-slate-400 mb-10 max-w-lg mx-auto lg:mx-0 leading-relaxed font-light">
                Join the leading ophthalmologists in Syria who trust Habash Med for precision,
        ...
        {[
          {
            ...
            text: 'Authorized partner for global brands',
          },
          {
          ...
          },
          {
            ...
            text: 'Comprehensive service coverage',
          },
        ].map((item, i) => (
          <div
            key={i}
            className="flex items-start gap-5 pt-6 md:pt-0 px-4 hover:bg-slate-50 transition-colors rounded-xl"
          >
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 px-4">
            <div className="max-w-2xl">
              ...
              <p className="text-slate-600 text-lg">
                State-of-the-art equipment tailored for every aspect of your ophthalmic practice.
              </p>
            </div>
            <Link
              to="/products"
              className="hidden md:flex items-center text-brand-600 font-bold hover:text-brand-700 transition-colors mt-4 md:mt-0"
            >
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8">
                  <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                    <p className="text-brand-300 text-xs font-bold uppercase tracking-wider mb-2 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-75">
                      Explore
                    </p>
                    <h3 className="text-white font-bold text-2xl mb-3 leading-tight group-hover:text-brand-100 transition-colors">
                      {cat.name}
                    </h3>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="group relative rounded-[2.5rem] overflow-hidden bg-slate-900 text-white shadow-2xl shadow-brand-900/40 transition-all duration-500 hover:shadow-brand-500/30 hover:-translate-y-1 border border-white/10">
            ...
            <div className="absolute inset-0 overflow-hidden">
              ...
              <div
                className="absolute top-[20%] -right-[20%] w-[70%] h-[100%] bg-cyan-500/20 rounded-full blur-[120px] animate-float"
            ...
            <div className="relative z-10 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center p-10 md:p-16 lg:p-20">
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="text-lg text-slate-400 mb-10 leading-relaxed max-w-xl mx-auto lg:mx-0 font-light">
                  Partner with Habash Med to access cutting-edge ophthalmic technology. We deliver
                  precision, reliability, and comprehensive support.
                </p>
                ...
                <div className="relative w-full max-w-md bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 p-6 flex flex-col justify-between shadow-2xl transition-all duration-500 hover:scale-[1.02] hover:shadow-brand-500/20">
                  ...
                  <div className="mt-6 flex items-end justify-between gap-2 h-24 px-2">
                    {[40, 70, 45, 90, 65, 85, 100].map((h, i) => (
                      <div
                        key={i}
                        className="w-full bg-white/5 rounded-t-sm relative overflow-hidden h-full flex items-end"
                      >
                        <div
                          className="w-full bg-gradient-to-t from-brand-600 to-cyan-400 animate-pulse"
                          style={{
                            height: `${h}%`,
