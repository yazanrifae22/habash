...
const ProductDetail: React.FC = () => {
  ...
  useEffect(() => {
    setLoading(true)
    fetch(`${WORKER_URL}/api/products/${id}`)
    ...
    return (
      <div className="min-h-screen flex items-center justify-center flex-col bg-slate-50">
        <div className="text-center p-8">
          ...
          <Link
            to="/products"
            className="px-6 py-3 bg-brand-500 text-white rounded-full font-bold hover:bg-brand-600 transition-colors inline-flex items-center shadow-lg"
          >
  ...
  const mainImage =
    ...
    product.images[0] ||
    `https://picsum.photos/seed/${product.id}/500/400`
      ...
      <div className="bg-white border-b border-slate-200 sticky top-0 z-30 shadow-sm">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2 text-sm">
            ...
            <Link
              to="/products"
              className="text-slate-500 hover:text-brand-600 transition-colors font-medium"
            >
              Products
            </Link>
            <span className="text-slate-300">/</span>
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/products"
              className="hidden sm:flex text-slate-500 hover:text-brand-600 transition-colors text-sm font-bold items-center group mr-4"
            >
            ...
            <div className="lg:w-1/2 bg-slate-50/50 p-8 md:p-16 flex flex-col relative border-b lg:border-b-0 lg:border-r border-slate-100">
              ...
              <div className="relative z-10 grid grid-cols-3 gap-4 mt-8">
                <div className="bg-white rounded-2xl p-4 border border-slate-100 shadow-sm text-center hover:shadow-md transition-shadow">
                  ...
                  <span className="text-[10px] sm:text-xs text-slate-900 font-bold block">
                    Warranty
                  </span>
                </div>
                <div className="bg-white rounded-2xl p-4 border border-slate-100 shadow-sm text-center hover:shadow-md transition-shadow">
